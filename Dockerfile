...
ENV CATKIN_PROJECT_DIR=$CATKIN_WS_SRC/copda
...
COPY daa_anchor_management_ros/package.xml $CATKIN_PROJECT_DIR/daa_anchor_management_ros/package.xml
COPY daa_bringup/package.xml               $CATKIN_PROJECT_DIR/daa_bringup/package.xml
COPY daa_color_classification/package.xml  $CATKIN_PROJECT_DIR/daa_color_classification/package.xml
COPY daa_knowledge_base_ros/package.xml    $CATKIN_PROJECT_DIR/daa_knowledge_base_ros/package.xml
COPY daa_msgs/package.xml                  $CATKIN_PROJECT_DIR/daa_msgs/package.xml
COPY daa_tools/package.xml                 $CATKIN_PROJECT_DIR/daa_tools/package.xml
COPY daa_tracker_ros/package.xml           $CATKIN_PROJECT_DIR/daa_tracker_ros/package.xml
